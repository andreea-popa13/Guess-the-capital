...
* **DevOps & Infrastructure:** Docker containerization using an Nginx base image.
...
1. **Build the image:** `docker build -t guess-the-capital .`
2. **Run the container:** `docker run -p 8080:80 guess-the-capital`
3. **Access the app:** Navigate to `http://localhost:8080` in your browser.
